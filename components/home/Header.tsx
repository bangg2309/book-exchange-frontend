...
const Header = () => {
    ...
    return (
        <header
            className={`${scrolled ? 'bg-green-800' : 'bg-green-700'} py-3 shadow-lg sticky top-0 z-50 transition-all duration-300`}>
            <div className="max-w-screen-xl mx-auto px-4 md:px-6 lg:px-8">
                <div className="flex items-center justify-between">
                    {/* Logo */}
                    <Link href="/" className="flex items-center space-x-2 group">
                        <div
                            className="relative overflow-hidden rounded-full border-2 border-white/70 transition-transform group-hover:scale-105">
                            <Image
                                src="/images/logo.jpg"
                                alt="Book Exchange"
                                width={40}
                        ...
                        <span
                            className="text-white font-bold text-xl group-hover:text-green-200 transition-colors">BookExchange</span>
                    </Link>
                        ...
                        {!isAuthenticated ? (
                            ...
                            <>
                                ...
                                <div className="hidden md:block relative group">
                                    ...
                                    >
                                        <div
                                            className="w-8 h-8 rounded-full bg-green-500 flex items-center justify-center overflow-hidden border-2 border-white/50">
                                            {currentUser?.avatar ? (
                                                <Image
                          ...
                          {(currentUser?.username || "U").charAt(0).toUpperCase()}
                                        ...
                                        <span
                                            className="text-white text-sm font-medium">{currentUser?.username || "Người dùng"}</span>
                                    ...
                                    {/* Dropdown Menu */}
                                    <div
                                        className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 ring-1 ring-black ring-opacity-5 focus:outline-none invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-150">
                                        <Link href="/profile"
                                              className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                            Tài khoản của tôi
                                        </Link>
                                        <Link href="/profile/buy-orders"
                                              className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                            Đơn mua
                                        </Link>
                                        <Link href="/profile/sell-orders"
                                              className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                            Sách đang bán
                                        </Link>
                ...
                <div className="md:hidden mt-4">
                    <div className="relative">
                        ...
                        />
                        <button
                            className="absolute right-3 top-1/2 transform -translate-y-1/2 hover:text-green-700 transition-colors">
                            ...
                            {!isAuthenticated ? (
                                ...
                                <>
                                    ...
                                    <div className="px-4 py-2 text-white flex items-center">
                                        <div
                                            className="w-8 h-8 rounded-full bg-green-500 flex items-center justify-center overflow-hidden mr-2 border-2 border-white/50">
                                            {currentUser?.avatar ? (
                                                <Image
                                                    src={currentUser.avatar}
                                                    alt={currentUser.username || "User"}
